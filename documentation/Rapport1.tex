...
participe passé, qui sera décrite dans la section \hyperref[accordpp]{\color{blue}{\ref{accordpp} Accord du participe passé}}. Plusieurs
...
\hyperref[vOptions]{\color{blue}{\ref{vOptions} Les options}}.
...
des options. Le fonctionnement en détail sera dans la section \hyperref[vOptions]{\color{blue}{\ref{vOptions} Les options}}.
...
le syntagme propositionnel, voir la section \hyperref[syntProp]{\color{blue}{\ref{syntProp} Le syntagme propositionnel}}.
...
nominaux. Tel que discuté dans la section \hyperref[pronomi]{\color{blue}{\ref{pronomi} La pronominalisation}}, celle-ci est très utile pour
...
par le passage à une variable. Voir la section \hyperref[clone]{\color{blue}{\ref{clone} Clone et déréférencement}}pour plus de détails.
...
interrogatives, mais l'approche utilisée et décrite dans la section \hyperref[question]{\color{blue}{\ref{question} La phrase interrogative}}
