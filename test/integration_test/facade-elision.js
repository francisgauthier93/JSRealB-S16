    ...
    }, function() 
    {
        QUnit.test( "Elision FR", function( assert ) {
            ...
            assert.equal(S(Pro("ce"),VP(V("être"),NP(D("un"),N("examen")),
                PP(P("de"),NP(N("école"))),AdvP(Adv("très"),A("aisé"),
                PP(P("à"),V("réussir").t("b"),PP(P("de"),NP(D("le"),N("coup"),A("premier"))))))).typ({neg:true}),
            ...
            assert.equal(S(CP(C("et"),S(NP(D("le"),N("histoire")),VP(V("être"),NP(D("un"),N("épreuve")))),
                        S(NP(D("le"),N("homme")),VP(V("respecter"),NP(D("le"),N("nature")))).typ({neg:'plus'}))),
