JSrealLoader({
    ...
    }, function() 
    {
        QUnit.test( "Elision FR", function( assert ) {
        	assert.equal(S(NP(D("le"),N("élève"),A("aimable")),VP(V("écrire").t("p"),PP(P("sur"),NP(D("le"),N("ardoise"))))), "L'élève aimable écrit sur l'ardoise.", "L'élève aimable écrit sur l'ardoise.");
            assert.equal(S(Pro("je").pe(1),VP(Pro("me").pe(2),V("aimer").t("p"),PP(P("pour"),NP(D("le"),N("éternité"))))), "Je t'aime pour l'éternité.", "Je t'aime pour l'éternité.");
            assert.equal(S(Pro("ce"),VP(V("être").t("p").vOpt({neg:true}),NP(D("un"),N("examen")),PP(P("de"),NP(N("école"))),AdvP(Adv("très"),A("aisé"),PP(P("à"),V("réussir"),PP(P("de"),NP(D("le"),N("coup"),A("premier"))))))),
            ...
            assert.equal(S(Pro("que"),Pro("je").pe(1),VP(V("aimer").t("p"),CP(C("et"),PP(P("à"),VP(V("faire"),NP(D("ce"),N("exercice")))),VP(V("voir"),NP(D("ce"),N("chien")))))),
             "Que j'aime à faire cet exercice et voir ce chien.","Que j'aime à faire cet exercice et voir ce chien.");
            assert.equal(S(Pro("que"),Pro("je"),VP(V("aimer").t("p"),VP(V("avoir"),PP(P("de"),NP(D("le"),N("exercice")))))), "Qu'il aime avoir de l'exercice.", "Qu'il aime avoir de l'exercice.");
            ...
            assert.equal(S(NP(D("le"),N("élève")),VP(Pro("me").pe(1),V("dire").t("pc"),PP(P("de"),VP(V("interroger"),NP(D("le"),N("fille")).pro())))),
                "L'élève m'a dit de l'interroger.","L'élève m'a dit de l'interroger.");
            assert.equal(S(CP(C("et"),S(NP(D("le"),N("histoire")),VP(V("être").t("p"),NP(D("un"),N("épreuve")))),
                        S(NP(D("le"),N("homme")),VP(V("respecter").t("p").vOpt({neg:'plus'}),NP(D("le"),N("nature")))))),
            ...
            assert.equal(S(Pro("ce"),VP(V("être").t("p"),PP(P("de"),NP(D("le"),N("affection"),SP(Pro("dont"),NP(D("ce"),N("enfant")),VP(V("avoir").t("p"),N("besoin"))))))),
                "C'est de l'affection dont cet enfant a besoin.","C'est de l'affection dont cet enfant a besoin.");
            assert.equal(S(NP(D("le"),N("hirondelle")),VP(Pro("me").pe(1),V("honorer").t("p").a(","),
                "mais",Pro("me").pe(1),V("amener").t("p"),CP(C("et"),PP(P("à"),NP(D("le"),N("hôpital"))),PP(P("à"),NP(D("le"),N("hibou")))))),
                "L'hirondelle m'honore, mais m'amène à l'hôpital et au hibou.","L'hirondelle m'honore, mais m'amène à l'hôpital et au hibou.");


            assert.equal(S(NP(D("le"),N("élève")),VP(Pro("me").pe(1),V("dire").t("pc"),PP(P("de"),VP(Adv("ne"),Adv("pas"),V("interroger"),NP(D("le"),N("fille")).pro())))),
